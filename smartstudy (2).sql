...
--
-- Hôte : 127.0.0.1
-- Généré le : sam. 13 déc. 2025 à 12:07
...
(12, 6, 'mourad', 0, 1, 0, '2025-12-07 18:09:16'),
(13, 6, 'mourad', 0, 1, 1, '2025-12-07 18:20:30'),
(14, 6, 'm', 0, 1, 1, '2025-12-07 18:23:06'),
(15, 6, 'm', 0, 1, 1, '2025-12-07 18:25:54'),
(16, 6, 'm', 0, 1, 1, '2025-12-07 18:26:27'),
(18, 6, 'ra', 0, 1, 6, '2025-12-08 11:47:15'),
(19, 6, 'hichem', 0, 1, 4, '2025-12-08 11:49:58'),
(21, 6, 'mourad', 1, 1, 2, '2025-12-08 11:51:43'),
(22, 6, 'mourad', 1, 1, 2, '2025-12-08 11:51:57'),
(23, 6, 'mourad', 1, 1, 9, '2025-12-08 13:26:11'),
(25, 1, 'ayoub', 0, 3, 15, '2025-12-10 19:04:11'),
(26, 6, 'dd', 0, 1, 2, '2025-12-10 19:04:33'),
(27, 6, 'ss', 0, 1, 9, '2025-12-10 20:55:50'),
(28, 1, 'n', 0, 3, 5, '2025-12-10 22:00:50'),
(29, 6, 'Marie Curie', 0, 1, 3, '2025-12-12 15:37:12');
...
--
-- Déchargement des données de la table `attempt_answers`
--

INSERT INTO `attempt_answers` (`id`, `attempt_id`, `question_id`, `selected`) VALUES
(2, 21, 11, 1),
(3, 22, 11, 1),
(4, 23, 11, 1),
(6, 29, 11, 3);
...
(6, 6, 'html 5 et javascript et php', 'cours html5,javascript et php ............', 'https://www.youtube.com/watch?v=7W1wb7U6e3c');
...
INSERT INTO `forums` (`id`, `title`, `category`, `author`, `content`, `created_at`, `updated_at`, `views`, `is_pinned`, `is_locked`) VALUES
(11, 'voir le  cours', 'Planning', 'ayoub', 'j ai de probleme en voir le cours\r\n', '2025-12-12 23:16:57', '2025-12-13 11:15:02', NULL, 0, 0);
...
(9, 1, 6, 'en html5 ou en ecrit le javascript', '<script> ... </script>', 'js', 'body', 'header', 1),
(10, 1, 6, 'ou en declare le css en html', 'body', 'header', 'footer', 'nav', 2),
(11, 6, 6, 'Comment déclarer une variable en PHP ?', '&c', '$c', 'c', '-c', 1);
...
INSERT INTO `replies` (`id`, `forum_id`, `parent_id`, `author`, `content`, `created_at`, `updated_at`, `is_solution`, `likes`) VALUES
(40, 11, NULL, 'admin', 'non c pas marche\r\n', '2025-12-12 23:17:54', '2025-12-12 23:17:58', 0, 1),
(41, 11, NULL, 'Marie Curie', 'non il faut de patata', '2025-12-12 23:23:12', '2025-12-12 23:23:12', 0, 0);
...
INSERT INTO `reports` (`id`, `reply_id`, `reporter_name`, `reason`, `status`, `created_at`) VALUES
(10, 40, 'Marie Curie', 'Harcèlement:', 'pending', '2025-12-12 22:22:21');
...
(50, 'Marie Curie', 'ayoubcherif18042005@gmail.com', '$2y$10$WcdUkIjSQVDCTvtKO8SRzeXRu0lxrNOjroCnm7h3f8xQ6Tzv7J48i', 'etudiant', NULL, NULL, NULL, NULL, NULL, NULL, '2025-12-08', 1, '11c2d1408d84152be8126816816dca7e0d8750b02feb4efb6624a9b6b84e37f2', '2025-12-13 12:04:08', NULL);
