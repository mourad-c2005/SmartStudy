...
<body>
  ...
  <nav class="top-nav">
    ...
    <div class="nav-menu">
      ...
      <a href="../index.php">revision</a>
      <a href="FrontOffice/forums.php">forums</a>
      <a href="groupes.php">Groupes</a>
      <a href="progres.php">Progrès</a>
      <a href="frontOffice/chatbot.php">Assistant</a>
    </div>
  ...
  <div class="main-content">
    ...
    <div class="row g-4">
      ...
      <div class="col-md-3">
        <a href="FrontOffice/forums.php" class="text-decoration-none">
          <div class="module-card">
            <i class="fas fa-users fa-3x"></i>
            <h5>forums</h5>
            <p>partager vos questions ensemble</p>
          </div>
        </a>
      </div>
      <div class="col-md-3">
