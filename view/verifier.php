        ...
        <style>
            * {
            ...
            .email-info {
                ...
                border-radius: 8px;
                margin: 20px 0;
                border-left: 4px solid #67b561ff;
            }
            ...
            .verify-btn {
                background: linear-gradient(135deg, #e2e2e2ff, #dadadaff);
                color: white;
                border: none;
                padding: 16px 40px;
                font-size: 18px;
            ...
            .verify-btn:hover {
                background: linear-gradient(135deg, #17ab46ff, #378c36ff);
                transform: translateY(-2px);
                box-shadow: 0 5px 15px rgba(72, 165, 100, 0.3);
            }
