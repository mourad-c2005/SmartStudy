...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['nom'])) {
    ...
    if (!empty($nom)) {
        try {
            ...
            // Simple insert - table should be fixed by fix_all_tables.php
...
<head>
  ...
  <title>Ajouter une Section | SmartStudy+ Admin</title>
...
<body>
  ...
  <div class="main-content">
    ...
    <div class="form-card">
      <h1><i class="fas fa-plus-circle"></i> Ajouter une Section</h1>
      ...
      <form method="POST" action="" id="sectionForm" novalidate>
        <div class="form-group">
          <label for="nom"><i class="fas fa-folder"></i> Nom de la section</label>
          <input type="text" id="nom" name="nom" placeholder="Ex: Développement Web" required value="<?= isset($_POST['nom']) ? htmlspecialchars($_POST['nom']) : '' ?>">
