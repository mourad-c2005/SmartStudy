<?php
// rapport_action.php - Dans le dossier controller
session_start();
    ...
    switch ($action) {
        ...
        case 'pin':
            if ($rapportModel->togglePin($rapportId)) {
                // Vérifier le nouvel état pour le message de succès
...
// Si aucune action valide, rediriger vers la page des rapports
