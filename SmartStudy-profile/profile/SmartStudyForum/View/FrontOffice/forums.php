<?php
// En haut de SmartStudyForum/View/FrontOffice/forums.php
session_start();
  ...
  <div class="nav-menu">
    ...
    <div class="user-section d-flex align-items-center gap-2">
      <div class="user-info text-end">
        <div class="name fw-bold"><?php echo $_SESSION['user']['nom']; ?></div>
        <div class="role text-muted small"><?php echo ucfirst($_SESSION['user']['role']); ?></div>
      </div>
