...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .admin-hero {
      background: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('https://images.unsplash.com/photo-1519389950470-47ba2e9b8d8d?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80') center/cover no-repeat;
      color: white;
      padding: 4rem 5%;
      border-radius: 20px;
      margin: 2rem 5%;
    ...
    @media (max-width: 992px) {
      ...
      .left-section, .nav-menu, .logout-btn { order: 1; }
      .admin-hero h1 { font-size: 2.2rem; }
      .admin-hero p { font-size: 1.1rem; }
      .main-content { padding: 1.5rem 3%; }
    }
  </style>
</head>
<body>
  ...
  <nav class="top-nav">
    ...
    <div class="nav-menu">
      ...
      <a href="user.php">Utilisateurs</a>
        <!-- ✅ AJOUT : Lien vers la gestion du forum (BackOffice) -->
      <a href="../../SmartStudyForum/View/BackOffice/manageForums.php">
  ...
  <div class="main-content">
    <div class="row g-4">
      ...
      <!-- Dans la section "Admin Modules", ajouter après "Gestion Utilisateurs" -->

     <div class="col-md-4">
      <a href="../../SmartStudyForum/View/BackOffice/manageForums.php" class="text-decoration-none">
        <div class="admin-card">
          <i class="fas fa-comments"></i>
          <h5>Gestion Forum</h5>
          <p>Modérer topics, réponses, signalements</p>
        </div>
      </a>
     </div>
      <div class="col-md-4">
