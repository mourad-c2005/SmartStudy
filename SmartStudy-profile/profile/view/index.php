...
<body>
  ...
  <nav class="top-nav">
    ...
    <div class="nav-menu">
      ...
      <!-- ✅ AJOUT : Forum FrontOffice (visible pour tous sauf admin) -->
      <?php if ($_SESSION['user']['role'] !== 'admin'): ?>
        <a href="../SmartStudyForum/View/FrontOffice/forums.php">
          <i class="fas fa-comments"></i> Forum
        </a>
        <a href="../SmartStudyForum/View/FrontOffice/chatbot.php">
    ...
    <div class="user-section">
      ...
      <!-- ✅ AJOUT : Bouton Administration (visible uniquement pour admin) -->
      <?php if ($_SESSION['user']['role'] === 'admin'): ?>
  ...
  <div class="main-content">
    ...
    <div class="row g-4">
      ...
      <!-- ✅ AJOUT : Cards Forum et Chatbot (visible pour non-admin) -->
      <?php if ($_SESSION['user']['role'] !== 'admin'): ?>
      <div class="col-md-6">
        <a href="../SmartStudyForum/View/FrontOffice/forums.php" class="text-decoration-none">
          <div class="module-card">
            <i class="fas fa-comments fa-3x"></i>
            <h5>Forum Étudiant</h5>
            <p>Posez vos questions, partagez vos connaissances</p>
          </div>
        </a>
      </div>
      <div class="col-md-6">
        <a href="../SmartStudyForum/View/FrontOffice/chatbot.php" class="text-decoration-none">
          <div class="module-card">
            <i class="fas fa-robot fa-3x"></i>
            <h5>Assistant IA Bien-être</h5>
            <p>Aide personnalisée pour votre bien-être</p>
          </div>
        </a>
      </div>
      <?php endif; ?>
